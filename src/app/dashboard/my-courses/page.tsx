      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400">
            Manage the courses you are offering for exchange.
          </p>
        </div>
        <div className="flex items-center gap-2">
          <div className="flex items-center bg-white dark:bg-zinc-900 rounded-lg p-1 border border-slate-200 dark:border-zinc-800">
            <button
              ...
              className={cn(
                ...
                viewMode === "grid"
                  ? "bg-slate-100 dark:bg-zinc-800 text-slate-900 dark:text-slate-50"
          ...
          <Button
            asChild
            className="bg-gradient-to-r from-violet-600 to-emerald-500 hover:from-violet-700 hover:to-emerald-600"
          >
            ...
            <table className="w-full text-sm text-left">
              ...
              <tbody>
                {courses.map((course: Course) => (
                  <tr
                    key={course._id}
                    className="border-b border-slate-100 dark:border-zinc-800 last:border-0 hover:bg-slate-50 dark:hover:bg-zinc-800/50 transition-colors group"
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <Image
                          ...
                          width={64}
                          height={40}
                          className="rounded object-cover bg-slate-200"
                          alt=""
                        />
