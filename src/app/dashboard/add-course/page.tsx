...
import { Loader2, Upload, CheckCircle2, TrendingUp } from "lucide-react";
        ...
        >
          ...
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400">
              Your course <strong>&quot;{formData.title}&quot;</strong> has been
              sent to administrators for review. It will appear in the
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4">
            ...
            <Button
              className="flex-1 bg-linear-to-r from-violet-600 to-indigo-600"
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      <div className="mb-8">
        ...
        <p className="text-slate-500 dark:text-slate-400">
          Share your expertise and start exchanging skills with others.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="p-6 md:p-8 bg-white dark:bg-zinc-900 border-slate-200 dark:border-zinc-800 shadow-xl shadow-slate-200/50 dark:shadow-none">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-zinc-800">
                <Button
                  type="submit"
                  className="w-full h-12 text-lg font-bold bg-linear-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 shadow-lg shadow-violet-200 dark:shadow-none"
                  disabled={loading}
                >
                  {loading ? (
                    <>
        ...
        <div className="space-y-6">
          <Card className="p-6 bg-white dark:bg-zinc-900 border-slate-200 dark:border-zinc-800 shadow-sm">
            <h3 className="text-sm font-bold uppercase tracking-wider text-slate-900 dark:text-slate-50 mb-4">
              Course Thumbnail
            </h3>
            ...
            <div className="mt-4 p-4 rounded-lg bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/20">
              ...
              <p className="text-[10px] leading-relaxed text-blue-600/80 dark:text-blue-400/70">
                Courses with high-quality thumbnails get 3x more exchange
                requests. Use 16:9 aspect ratio for best results.
              </p>
            </div>
          </Card>
