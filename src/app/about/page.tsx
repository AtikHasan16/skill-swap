  ...
  const values = [
    {
      ...
      description:
        "We believe in the power of people helping people to grow and succeed together.",
    },
    {
      icon: <Target className="h-6 w-6 text-emerald-600" />,
      title: "Growth Mindset",
      description:
        "Learning never stops. We provide the platform for continuous self-improvement.",
    },
    {
      icon: <Rocket className="h-6 w-6 text-blue-600" />,
      title: "Zero Cost Learning",
      description:
        "Knowledge should be accessible. Our currency is time and expertise, not money.",
    },
    {
      icon: <Heart className="h-6 w-6 text-rose-600" />,
      title: "Mutual Respect",
      description:
        "Every skill has value. We foster an environment of appreciation and support.",
    },
  ];
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed">
                Skill Swap is more than just a platform; it's a global movement
                to democratize knowledge. Our mission is to connect experts with
                learners in a mutually beneficial ecosystem.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mb-16">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400">
                Core principles that guide us in building the most trusted
                skill-sharing community in the world.
              </p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="lg:w-1/2 relative">
                ...
                <Image
                  ...
                  width={800}
                  height={600}
                  className="rounded-3xl shadow-2xl relative z-10 border-8 border-white dark:border-zinc-900 w-full h-auto"
                />
              </div>
              <div className="lg:w-1/2">
                <h2 className="text-3xl md:text-4xl font-bold mb-8 text-slate-900 dark:text-white">
                  The Skill Swap Story
                </h2>
                <div className="space-y-6 text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                  <p>
                    It started with a simple problem: expensive education and
                    hidden barriers to learning specific, practical skills. We
                    saw incredible people with deep expertise unable to share
                    it, and curious minds unable to afford traditional courses.
                  </p>
                  <p>
                    In 2024, we launched Skill Swap with the vision that
                    knowledge should be traded, not bought. Whether you're a
                    developer wanting to learn design, or a gardener wanting to
                    learn coding, there's someone on our platform ready to swap.
                  </p>
