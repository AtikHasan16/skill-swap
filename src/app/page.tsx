        ...
        <section className="container mx-auto px-4 py-24 md:px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-slate-500 text-lg">
              The most trending skill trades in our community right now.
            </p>
          </div>
            ...
            {popularCourses.length > 0 ? (
              popularCourses.map(
                (course: {
                  ...
                  thumbnailUrl: string;
                  platform: string;
                  currentOwner: { name: string; photoURL: string };
                }) => (
                  <CourseCard
                    key={course._id}
                    id={course._id}
          ...
          <div className="mt-12 flex justify-center">
            <Button
              ...
              size="lg"
              asChild
              className="rounded-full px-8 group border-violet-200 hover:border-violet-500 transition-colors"
            >
        ...
        <section className="bg-slate-50 dark:bg-zinc-900/50 py-24 border-y border-slate-100 dark:border-zinc-800">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-slate-500 text-lg">
                Your journey to new skills starts here. Exchange knowledge in
                three simple steps.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6 leading-tight">
                Why thousands of learners trust{" "}
                <span className="bg-linear-to-r from-violet-600 to-emerald-500 bg-clip-text text-transparent">
                  SkillSwap
                </span>
              </h2>
              <p className="text-slate-500 text-lg mb-8 leading-relaxed">
                We&apos;re building a community-driven future where education is
                accessible through collaboration, not transactions.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Every instructor and course is vetted for quality and authenticity.",
                    icon: <ShieldCheck className="h-5 w-5 text-emerald-500" />,
                  },
                  {
                    title: "Secure Platform",
                    desc: "Automated ownership swaps ensure fair trades every time.",
                    icon: <LockIcon className="h-5 w-5 text-violet-500" />,
                  },
                  {
                    title: "Global Reputation",
                    desc: "Build your leaderboard status and become a top-tier mentor.",
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-linear-to-tr from-violet-600/20 to-emerald-500/20 rounded-3xl blur-2xl -z-10" />
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4 pt-8">
                  ...
                  <div className="bg-violet-600 p-6 rounded-2xl shadow-xl transform hover:-translate-y-1 transition-transform">
                    ...
                    <div className="text-xs text-violet-100 uppercase font-semibold">
                      Instant Access
                    </div>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="bg-emerald-500 p-6 rounded-2xl shadow-xl transform hover:-translate-y-1 transition-transform">
                    ...
                    <div className="text-xs text-emerald-50 uppercase font-semibold">
                      Success Rate
                    </div>
                  </div>
                  <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-slate-200 dark:border-zinc-800 shadow-sm">
        ...
        <section className="bg-slate-50 dark:bg-zinc-900/50 py-24 border-t border-slate-100 dark:border-zinc-800 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-slate-500 text-lg">
                Don’t just take our word for it—hear from the people who are
                redefining learning.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <Card
                  key={i}
                  spotlight
                  className="p-8 h-full flex flex-col border-slate-200/60 dark:border-zinc-800/60 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm relative group overflow-visible"
                >
