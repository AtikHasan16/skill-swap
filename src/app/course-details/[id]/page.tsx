...
export default function CourseDetails() {
  ...
  const handleExchange = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        const errorMsg =
          data.message || data.error || "Failed to send exchange request";
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <span
                  className={`rounded-full px-3 py-1 text-xs font-semibold text-white bg-blue-600`}
                >
                  {course.platform}
                </span>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <Card className="p-6 border-slate-200 dark:border-zinc-800 shadow-xl bg-white dark:bg-zinc-900">
                ...
                <Button
                  size="lg"
                  className={`w-full text-lg font-semibold shadow-lg transition-transform active:scale-95 ${
                    !course.isAvailable
      ...
      >
        <div className="space-y-6">
          <p className="text-slate-600">
            Select a course from your library to offer in exchange for{" "}
            <strong>{course.title}</strong>.
          </p>

          <div className="space-y-3 max-h-60 overflow-y-auto pr-2">
            {myCourses && myCourses.length > 0 ? (
              myCourses.map((myCourse: Course) => (
                <div
                  key={myCourse._id}
                ...
                >
                  <div className="h-10 w-10 bg-slate-200 rounded-md mr-3 overflow-hidden relative">
                    <Image
                      src={
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-slate-100 dark:border-zinc-800">
            ...
            <Button
              ...
              className="bg-linear-to-r from-violet-600 to-emerald-500 text-white"
            >
