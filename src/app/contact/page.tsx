          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                Have questions about Skill Swap? We're here to help. Reach out
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-3 opacity-90">
                      <div className="flex items-center justify-between text-sm">
                        <span className="flex items-center gap-2">
                          <Clock className="h-4 w-4" /> Weekdays
                        </span>
                        <span>9am - 8pm</span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        <span className="flex items-center gap-2">
                          <Clock className="h-4 w-4" /> Weekends
                        </span>
                        <span>10am - 4pm</span>
                      </div>
                    </div>
                    <div className="mt-8">
                      <p className="text-sm font-medium mb-4">
                        We're expanding our global support soon!
                      </p>
                      <div className="flex -space-x-2">
                        {[1, 2, 3, 4].map((n) => (
                          <div
                            key={n}
                            className="w-8 h-8 rounded-full border-2 border-violet-600 bg-slate-200 overflow-hidden relative"
                          >
                            <Image
