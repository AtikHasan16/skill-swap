...
export function CourseCard({
  ...
  return (
    ...
    >
      <Card
        spotlight
        className="group h-full flex flex-col cursor-pointer overflow-hidden border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900"
      >
        {/* Image Section */}
        <div className="relative aspect-video w-full overflow-hidden bg-slate-100">
          <div className="absolute inset-0 z-10 bg-linear-to-t from-black/60 to-transparent opacity-60 transition-opacity group-hover:opacity-80" />
          <Image
            src={image}
            alt={title}
            fill
