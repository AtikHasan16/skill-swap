                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "text-violet-600 bg-violet-50 dark:bg-violet-900/10 rounded-full"
                  ...
                  <AnimatePresence>
                    {isUserMenuOpen && (
                      ...
                      >
                        <Link
                          href="/dashboard"
                          className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-card-foreground hover:bg-slate-100 dark:hover:bg-slate-800"
                        ...
                        <button
                          className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm text-red-500 hover:bg-red-50 dark:hover:bg-red-900/10"
              ...
              <div className="flex flex-col p-4 space-y-2">
                ...
                {!isAuthenticated && (
                  <div className="flex flex-col gap-2">
                    <Link
                      href="/login"
                      className="px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-violet-600 hover:bg-slate-50 dark:hover:bg-zinc-900 rounded-lg"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      Log in
                    </Link>
                    <Link
                      href="/register"
                      className="px-4 py-2 text-sm font-medium text-white bg-violet-600 hover:bg-violet-700 rounded-lg text-center shadow-md"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      Sign up
                    </Link>
